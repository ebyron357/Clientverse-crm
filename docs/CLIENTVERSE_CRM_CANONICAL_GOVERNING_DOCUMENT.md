...
**Version:** 1.9 — complete replacement
...
- `claude/clientverse-scope-recovery-bj6u7w` has been restarted from `main@730b1b3` and carries only this reconciliation. No work branch currently carries unmerged *capability* work.
