...
**Version:** 1.8 — complete replacement
...
- `claude/clientverse-scope-recovery-bj6u7w` (PR #28, open) carries unmerged capability work: the Recovery Case and normalized recovery-event foundation (E-21) and the recovery runner (E-22). Status `TESTED`, not `MERGED`.
