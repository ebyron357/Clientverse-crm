...
export const CLIENTVERSE_MODULES = [
  ...
  { id: "operations", group: "Automation", label: "Operations", description: "Durable work queue, recovery candidates, and the external-capability security gate", route: "/operations", icon: Workflow, state: MODULE_STATES.AVAILABLE, contract: "GET /api/work-queue | GET /api/next-best-actions | GET /api/security-gate/status", actions: ["view", "acknowledge", "resolve", "replay"] },
