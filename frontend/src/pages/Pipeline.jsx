...
export default function Pipeline() {
  ...
  const load = useCallback(async () => {
    ...
    catch (requestError) { setError("The pipeline could not be loaded. Your records are unchanged — try refreshing when the connection is available."); }
